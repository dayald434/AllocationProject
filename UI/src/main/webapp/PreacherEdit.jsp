    ...
    <form class="form1" action="RegisterSewadar.jsp" method="post" name="PreacherForm" onsubmit="return(validate());">
        ...
        <TABLE cellspacing="3" align="center" style="height:50%; border: none; width: 90%;" class="table1">
            ...
            <TR>
                ...
                <TD>
                    <input required <%out.println("value='" + nullToEmpty(preacher.getMobile1()) + "'"); %> name="Mobile1" id="Mobile1" class="txt1" pattern="[1-9]{1}[0-9]{9}" maxlength="10" class="field-style field-full align-none" placeholder="Mobile 1"/>
