...
<head>
    ...
    <script type="text/javascript">
        ...
        function loadSchedule() {
            ...
            var url = "SchedulingReport.jsp?SgId=" + sgId + "&StartDate=" + startDate + "&EndDate=" + endDate;
...
<center>
    ...
    <form class="formSmall" action="" onsubmit="return(loadSchedule());">
        <BR>
        <font class="header1"><B class="header1">Satsang Ghar Report</B></font>
    ...
    <iframe src="SchedulingReport.jsp?Action=Load" id="sframe" frameborder="0" scrolling="no" style="width: 90%" onload="resizeIframe(this)"/>
