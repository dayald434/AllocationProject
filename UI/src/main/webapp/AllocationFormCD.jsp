...
<head>
    ...
    <script type="text/javascript">
        ...
        function loadSchedule() {
            ...
            var url = "SchedulingCD.jsp?SgId=" + sgId + "&StartDate=" + startDate + "&EndDate=" + endDate ;
...
<center>
    ...
    <iframe src="SchedulingCD.jsp?Action=Load" id="sframe" frameborder="0" scrolling="no" style="width: 90%"
